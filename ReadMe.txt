...
NB: Pour l'instant, seuls l'enregistrement d'un article, l'affichage des détails d'un article enregistré et la gestion d'exceptions sur le format de la reference d'un article ont été impléméntés.
